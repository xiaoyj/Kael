...
public class ChangeTheWallPicture {
    public void ChangeTheWallPicture() {
      ...
      */
            ...
            boolean result = ChangeTheWallPicture.MyUser32.INSTANCE.SystemParametersInfoA(SPI_SETDESKWALLPAPER, 0,
  ...
  */
    {
        ChangeTheWallPicture.MyUser32 INSTANCE = (ChangeTheWallPicture.MyUser32) Native.loadLibrary("user32", ChangeTheWallPicture.MyUser32.class);
